...
(function() {
	...
	var $cmr = {
		...
		switcher: function(cmr) {
			...
			if (wide) {
				//cmr.classList.add('js-nav-bar--wide');
				//cmr.classList.remove('js-nav-bar--narrow');
                //cmr.classList.add(js_classname_prefix + '-' + cmr.dataset.jsCmrComponent + '-cmr--' + container_js_classname_wide_suffix);
                cmr.classList.add(js_classname_prefix + '-cmr--' + container_js_classname_wide_suffix);
                //cmr.classList.remove(js_classname_prefix + '-' + cmr.dataset.jsCmrComponent + '-cmr--' + container_js_classname_narrow_suffix);
                cmr.classList.remove(js_classname_prefix + '-cmr--' + container_js_classname_narrow_suffix);
                
				cmr.style.outline = '3px solid red';
			} else {
				//cmr.classList.add('js-nav-bar--narrow');
				//cmr.classList.remove('js-nav-bar--wide');
                //cmr.classList.add(js_classname_prefix + '-' + cmr.dataset.jsCmrComponent + '-cmr--' + container_js_classname_narrow_suffix);
                cmr.classList.add(js_classname_prefix + '-cmr--' + container_js_classname_narrow_suffix);
                //cmr.classList.remove(js_classname_prefix + '-' + cmr.dataset.jsCmrComponent + '-cmr--' + container_js_classname_wide_suffix);
        ...
        set_breakpoints: function(cmrs) {
            Array.prototype.forEach.call(cmrs, function (cmr, i) {
                ...
                //clone.classList.add('js-nav-bar--wide');
                // Why wide to start with?
                // tmp              js                                    navbar                             wide
                //clone.classList.add(js_classname_prefix + '-' + clone.dataset.jsCmrComponent + '-cmr--' + container_js_classname_wide_suffix);
        ...
        init: function() {
            ...
            //if (css_is_loaded) {
                ...
                $cmr.cmrs = document.querySelectorAll('[data-js="cmr"][data-js-cmr-component]');
                ...
                Array.prototype.forEach.call($cmr.cmrs, function (cmr, i) {
                    if (!(cmr.dataset.jsCmrComponent in $cmr.cmrs_grouped)) {
                        //console.log('Adding ' + cmr.dataset.jsCmrComponent);
                        $cmr.cmrs_grouped[cmr.dataset.jsCmrComponent] = new Array();
                    }
                    $cmr.cmrs_grouped[cmr.dataset.jsCmrComponent].push(cmr);
                });
